...
async def main():
    ...
    # with open("robotdog_graph8.png", "wb") as f:
    #     f.write(graph_png)
    # print("Graph saved.")    
    ...
    while True:
        ...
        config_thread = {"configurable": {"thread_id": thread_id}, "recursion_limit": 1000}  # this is number of nodes it will execute before hitting a END condition
